                ...
                return `
                    <li data-id="${document.id}" name="list">
                        <span class="list-title">
                            <button class="toggle-btn" isClosed="true">▶︎</button>
                            ${document.title}
                        </span>
                        <span class="list-btn-box">
                            <button name="add-btn" data-id="${document.id}">
                                <i class="far fa-plus-square"></i>
                            </button>
                            <button name="remove-btn" data-id="${document.id}">
                        ...
                        ${document.documents.length ? 
                          ...
                          : `<ul style="display: ${display}">
                                <li>
                                    <span class="no-page">하위 페이지가 없습니다</span>
                                </li>
                            </ul>`
                        }
                    </li>
